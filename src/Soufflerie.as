package  
{
	...
	public class Soufflerie extends FlxSprite 
	{
		...
		[Embed(source = '../assets/gfx/gameplay/partSoufflerie.png')] protected var ImgPartSoufflerie:Class;
		...
		public function Soufflerie(xpos:int, ypos:int, orient:int) 
		{
			...
			emitter = new FlxEmitter(this.x, this.x, 20);
			for(var i:int = 0; i < 10; i++) {
				var p:FlxParticle = new FlxParticle();
				p.loadGraphic(ImgPartSoufflerie);
				emitter.add(p);
			}
		}
